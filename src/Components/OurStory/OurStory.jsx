      ...
      <div className="our-stories-third-card-parents">
        ...
        >
          ...
          <div className="our-stories-third-card-icons-with-text">
            ...
            <span>
              <span>Ambitious and inspiring</span> : It aims to make a positive
          ...
          <div className="our-stories-third-card-icons-with-text">
            <IoMdCheckmarkCircleOutline size={30} color="#ff3c00" />
            <span>
              <span>Specific</span>: The company's focus is stated to be on
              user-centric design and impactful solutions.
            </span>
          </div>
          <div className="our-stories-third-card-icons-with-text">
            <IoMdCheckmarkCircleOutline size={30} color="#ff3c00" />
            <span>
              <span>Action-oriented</span>: The company's focus is on developing
              solutions that empower users, and this is emphasized.
            </span>
          </div>
          <div className="our-stories-third-card-icons-with-text">
            <IoMdCheckmarkCircleOutline size={30} color="#ff3c00" />
          ...
          <div className="our-stories-third-card-icons-with-text">
            <IoMdCheckmarkCircleOutline size={30} color="#ff3c00" />
            <span>
              <span>Innovation</span> : To constantly push the boundaries of
              what's possible with software, in order to be at the forefront of
